...
const CurrencySettings = () => {
  ...
  return (
    <React.Suspense fallback={<CurrencySettingsSkeleton />}>
...
function CurrencySettingsSkeleton() {
  const initialValues = {
    preferredCurrency: {
      code: "",
      locale: "",
          ...
          <Form>
            <div className="bg-white rounded-lg">
              <header className="py-4 border-b border-b-greyborder">
                ...
                <p className="font-satoshi text-tiny leading-150 tracking-normal mt-1">
                  Configure your preferred currency and available currency
                  options
                </p>
              </header>
              ...
              <section className="py-4 border-b border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="w-full flex flex-col gap-y-2">
                    ...
                    <Field
                      ...
                      max="3"
                      className={cn(
                        "w-full border border-greyborder focus:border-accent p-3 bg-white font-satoshi font-normal text-tiny outline-none placeholder-black leading-100 tracking-0 disabled:placeholder:text-greyborder",
                        {
                          "border-error focus:border-error":
                            touched?.preferredCurrency?.decimals &&
                            errors?.preferredCurrency?.decimals,
                  ...
                  <div className="flex items-center">
                    <Field
                      type="checkbox"
                      name="preferredCurrency.show_symbol"
                      className="h-4 w-4 text-accent-600 focus:border-accent-600 border-greyborder rounded-full disabled:text-greyborder"
                      disabled
                    />
                    <label className="ml-2 font-satoshi font-normal text-small leading-100 tracking-normal">
                      Show Currency Symbol
                ...
                <div className="mt-4 p-4 bg-grey rounded-md">
                  ...
                  <div className="font-satoshi font-normal text-large leading-150 tracking-normal">
                    {values?.preferredCurrency?.code
                      ? formatCurrency(1234567.89, values.preferredCurrency)
                      : "Select a currency to preview"}
                  </div>
                </div>
              </section>
              ...
              <div className="py-4">
                ...
                <div className="relative mb-4">
                  <input
                    type="text"
                    placeholder="Search currencies..."
                    className="w-full border border-greyborder focus:border-accent p-3 bg-white font-satoshi font-normal text-tiny outline-none placeholder-black leading-100 tracking-0 appearance-none resize-none disabled:placeholder:text-greyborder"
                    disabled
                  />
                  <div className="absolute inset-y-0 right-0 flex items-center pr-3">
                    <svg
                      ...
                      >
                        ...
                        <button
                          ...
                          onClick={() => {
                            ...
                            setFieldValue("availableCurrencies", newCurrencies);
                          }}
                          className="ml-1.5 inline-flex items-center justify-center"
                        >
                          <span className="sr-only">Remove</span>
                ...
                {errors.availableCurrencies && touched.availableCurrencies && (
                  <div className="text-red-500 text-sm mt-1">
                    {errors.availableCurrencies}
                  </div>
                )}
