      ...
      >
        <View style={styles.header}>
          <View style={styles.header_col}>
            <View style={styles.logo}>
              {logo ? <Image src={logo} width="50" height="50" /> : null}
            </View>
          ...
          <View style={styles.header_col}>
            <View>
              {shipping_address ? (
                <>
                  <Text style={[styles.header_heading, styles.fw_bold]}>
                    Shipping address
                  </Text>
          ...
          <View style={[styles.header_col]}>
            <Text
              style={[styles.marginBottom, styles.text_xl, styles.textRight]}
            >
              {title}
            </Text>
        ...
        {items.map((item, index) => {
          ...
          return (
            <View key={index} style={[styles.item_row, styles.border_b]}>
              ...
              <Text style={[styles.item, styles.flex_1, styles.fs_small]}>
        ...
        <View style={styles.footer}>
          <View style={[styles.flex_1, styles.col, styles.itemsDown]}>
            {notes ? (
              <View style={styles.marginBottom}>
                <Text style={[styles.marginBottom, styles.textLeft]}>
                  Notes
                </Text>
          ...
          <View style={[styles.flex_1, styles.col, styles.itemsDown]}>
            ...
            <View style={[styles.marginBottom]}>
              <Text style={styles.textRight}>
                Discount: {currencyFormatter(discount || 0, currency)}
              </Text>
            </View>
            <View style={[styles.marginBottom]}>
              <Text style={styles.textRight}>
            ...
            <View style={[styles.marginBottom]}>
              <Text style={styles.textRight}>
                Shipping: {currencyFormatter(shipping || 0, currency)}
              </Text>
            </View>
            <View style={[styles.marginBottom]}>
              <Text style={styles.textRight}>
                Paid Amount: {currencyFormatter(paid || 0, currency)}
              </Text>
            </View>
            <View style={[styles.marginBottom]}>
              <Text style={styles.textRight}>
                Balance Due:{" "}
                {currencyFormatter(
                  Number(items.reduce((acc, cur) => acc + cur.amount, 0)) +
                    Number(tax) +
                    Number(shipping) -
                    Number(discount) -
                    Number(paid) || 0,
